...
-- This allows the messages table to support different types of messages (text, video, image, etc.)

-- Add message_type column with default value
ALTER TABLE messages 
ADD COLUMN IF NOT EXISTS message_type INTEGER DEFAULT 0; -- 0: text, 1: image, 2: video, 3: audio, etc.

-- Add metadata column for storing additional message data (like video URLs, thumbnails, etc.)
ALTER TABLE messages 
